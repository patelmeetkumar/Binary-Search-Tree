...
/*
 * An interface for the search tree.
 */
...
public interface SearchTreeInterface<T extends Comparable<? super T>> extends TreeInterface<T> 
{
	...
	/**
	 * Adds a new entry to this tree. If the entry matches an object that exists in
	 * the tree already, replaces the object with the new entry. 
	 * @param newEntry an object to be added to the tree 
	 * @return either null if newEntry was not in the tree already, or an existing entry that 
